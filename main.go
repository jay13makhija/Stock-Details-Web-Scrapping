...
type Stock struct {
	company, price, changePrice string
}
...
func main() {
	...
	c.OnHTML("div#quote-header-info", func(e *colly.HTMLElement) {
		...
		stock.changePrice = e.ChildText("fin-streamer[data-field='regularMarketChangePercent']")
		fmt.Println("Change Price:", stock.changePrice)
